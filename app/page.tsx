...
const translations = {
  id: {
    ...
    flymeSoundInteriorDesc:
      "Pengalaman audio imersif berkualitas konser di setiap perjalanan",
    ...
    dataSecure:
      "Tim dealer resmi Geely Surabaya akan segera menghubungi Anda melalui WhatsApp untuk konfirmasi jadwal test drive.",
    ...
    copyright:
      "© 2025 Dealer Resmi Geely Surabaya - Jawa Timur. Hak Cipta Dilindungi.",

    // Form Message
    formMessage:
      "Halo, saya tertarik test drive gratis mobil listrik EV Geely EX5 MAX:",
    formName: "Nama:",
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          {heroImages.map((image, index) => (
            ...
            >
              <Image
                ...
                alt={`Geely EX5 MAX - Mobil Listrik EV Premium Surabaya ${
                  index + 1
                }`}
                fill
              ...
              <div className="relative overflow-hidden rounded-lg shadow-2xl">
                {interiorImages.map((image, index) => (
                  ...
                  >
                    <Image
                      src={image || "/placeholder.svg"}
                      alt={`Interior Mewah Geely EX5 MAX - Mobil Listrik EV Premium ${
                        index + 1
                      }`}
                      width={800}
                      height={600}
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    >
                      <SelectTrigger
                        className="mt-1"
                        aria-label="Pilih waktu test drive"
                      >
      ...
      <div className="sr-only">
        <h1>
          Dealer Resmi Geely Surabaya - Mobil Listrik EV Terbaik Jawa Timur
        </h1>
        <p>
          Geely Surabaya adalah dealer resmi mobil listrik EV terpercaya di Jawa
          Timur. Kami menyediakan berbagai varian mobil listrik terbaru seperti
          Geely EX5 MAX, Geely Starwish, dan Geely Starray dengan teknologi
          canggih dan ramah lingkungan.
        </p>
        <p>
          Kunjungi showroom Geely Surabaya di Jl. Sulawesi No.69, Gubeng untuk
          test drive gratis dan konsultasi lengkap mengenai mobil listrik EV
          terbaik. Tim profesional kami siap membantu Anda menemukan mobil
          listrik yang sesuai dengan kebutuhan dan budget.
        </p>
        <p>
          Geely EX5 MAX hadir dengan teknologi ADAS terlengkap, performa tinggi
          214 HP, dan fitur keamanan canggih. Dapatkan harga terbaik dan program
          kredit menarik hanya di dealer resmi Geely Surabaya.
        </p>
      </div>
    </div>
  );
